...
(function () {
  ...
  function getStateGISPortal(state) {
    ...
    const statePortals = {
      'Texas': { name: 'Texas Natural Resources Information System (TNRIS)', link: 'https://data.tnris.org/', desc: 'Texas statewide GIS data — imagery, elevation, hydrography, boundaries, parcels in select counties.' },
      'California': { name: 'California Geoportal', link: 'https://gis.data.ca.gov/', desc: 'California open GIS data — statewide parcels, land use, environmental, transportation.' },
      'New York': { name: 'NY State GIS Clearinghouse', link: 'https://gis.ny.gov/', desc: 'New York GIS data — parcels, orthoimagery, boundaries, environmental layers.' },
      'Florida': { name: 'Florida DEP Geospatial Open Data', link: 'https://geodata.dep.state.fl.us/', desc: 'Florida environmental and land data — parcels, wetlands, conservation lands.' },
      'Colorado': { name: 'Colorado Information Marketplace', link: 'https://data.colorado.gov/', desc: 'Colorado statewide GIS data portal — parcels, water rights, mining claims, transportation, hazards.' },
